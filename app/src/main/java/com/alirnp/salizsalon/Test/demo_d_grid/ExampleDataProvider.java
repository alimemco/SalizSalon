...
public class ExampleDataProvider extends AbstractDataProvider {
    ...
    public ExampleDataProvider(List<Item> items) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            mData.add(new ConcreteData(id, url, viewType, url, swipeReaction));
        }
    ...
    public static final class ConcreteData extends Data {
        ...
        ConcreteData(long id, String url, int viewType, @NonNull String text, int swipeReaction) {
            mId = id;
            mViewType = viewType;
            mUrl = url;
